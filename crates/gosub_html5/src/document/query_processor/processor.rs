...
use gosub_shared::traits::document::query::{Query, Condition, SearchType};
...
impl <C: HasDocument> gosub_shared::traits::document::query::QueryProcessor<C> for QueryProcessor<C> {
